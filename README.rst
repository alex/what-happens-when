...
it. It is important to clarify that the suggestions shown are not only those
that begin with the letter g, but also those that the algorithm considers 
and that contain this letter or any other
