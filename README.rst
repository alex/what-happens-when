...
When you type google.com in your browser and press Enter
 The Browser initiates TCP connection with the server.It sends the HTTP request to the server,then the server processes the request,sends back a response and then the browser renders the content.
