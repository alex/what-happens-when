...
* It would also check to confirm that the network is tying to connect to an allowed port on the server while preventing connections to unauthorized ports on
  the server
