...
used to connect keyboards to computers over the years. 
PS/2 and ADB are older connector types that were commonly used in desktop
computers and AppleMacintosh computers, respectively. USB is a newer and more
universal connector that is now the most common type of connector for computer
keyboards. Bluetooth is a wireless technology that allows keyboards to connect
to computers without the need for a physical cable.
