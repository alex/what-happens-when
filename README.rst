...
If the Google homepage is dynamic, it may be generated by an application server. An application server is a software program that runs web applications. 

If the Google homepage contains any dynamic content, such as search results, this content may be stored in a database. The application server may query the database to retrieve this content.
