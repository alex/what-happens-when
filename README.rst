...
unable to identify IP address of <div style="display: inline">https://www.google.com</div>, it locates the root server
...
<div style="display: inline">https://www.google.com</div>, if it doesn’t know the IP address. Yet again, the resolver
