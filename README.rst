...
(Korean), `Spanish`_ and `Brazilian Portuguese`_. NOTE: these have not been reviewed by the alex/what-happens-when
maintainers.
...
.. _`Brazilian Portuguese`: https://github.com/RianNegreiros/what-happens-when-pt_BR