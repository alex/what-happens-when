...
* Parsing - HTML, CSS, JS
The rendering of static contents such as HTML, CSS and JS is handled by the
web sever which can be Nginx, Apache e.t.c while the dynamic contents are
generated by the application server which can also make request to the database.
