...
NOTE: A web address could also have a path which is indicated after link and a forward slash (for example https://www.google.com/search?linkedin) in which case search?linkedin is the path
