...
of each key switch, Eliminating and reducing the electrical noise of the rapid intermittent
closure of the switch, and converts it to a keycode integer, in this case 13.
The Keyboard's logic circuitry interprets the closed circuit as a keycode.
Different keys have different keycodes and the "Enter" key corresponds to 13.
